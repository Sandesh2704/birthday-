...
import audio from "../asset/a-birthday-to-remember-201324.mp3"
...
//       <div className="fixed bottom-4 flex items-center space-x-2 bg-pink-600 text-white px-4 py-2 rounded-full shadow-lg">
//         <button
//           onClick={toggleMute}
...
//   const cardsRef = useRef([]);
//   const videoRef = useRef(null); // Ref for the hidden video
//   const [isVideoPaused, setIsVideoPaused] = useState(); // State to manage video pause
...
//           onClick={toggleMute}
//           className="text-lg focus:outline-none"
//           aria-label={isVideoPaused ? "Unmute" : "Mute"}
//         >
//           Sounds: {isVideoPaused ? "🔊": "🔇" }
//         </button>
//       </div>
//     </>
//   );
...
//   const [isVideoMuted, setIsVideoMuted] = useState(false); // Manage mute state
//   const [isVideoPlaying, setIsVideoPlaying] = useState(false); // Track whether the video is playing

//   useEffect(() => {
//     // Do not attempt to play the video until after user interaction
//     const videoElement = videoRef.current;
//     if (videoElement) {
//       videoElement.muted = isVideoMuted; // Set mute state on video element
//     }
//   }, [isVideoMuted]);
...
//       setIsVideoMuted(newMuteState); // Update state
//     }
//   };
...
//     <>
//       <div>
//         {/* The video is not autoplaying initially. We'll wait for user interaction */}
//         <video
//           ref={videoRef}
//           src={video}
//           loop
//           muted={isVideoMuted} // Set initial mute state
//           controls
//           className="w-full h-auto hidden"
//         />
//       </div>
...
//           onClick={() => {
//             toggleMute();
//             togglePlayPause(); // Ensure that clicking toggles both mute and play/pause
//           }}
